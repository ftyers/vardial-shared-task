...
Please, name your tagged test sets in the following way: `roa-uncovered.N.TEAM` and `trk-uncovered.N.TEAM`. Here `N`is the track number and `TEAM` is your team name. Send your output files to vardial2019cma 'at' gmail 'dot' com at the lates March 8 (23:59 UTC-12). Please indicate your name and team name in the email message.
